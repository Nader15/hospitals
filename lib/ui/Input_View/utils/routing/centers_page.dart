...
class CentersCategoryBody extends StatefulWidget {


  @override
  _CentersCategoryBodyState createState() => _CentersCategoryBodyState();
}

class _CentersCategoryBodyState extends State<CentersCategoryBody> {
  ...
  gettingData() {
    setState(() {
      ...
      Api(context)
          .filterCentersApi(_scaffoldKey, depIdGlobal, items)
          .then((value) {
        setState(() {
          items = value;
        });
